...
- компактные горизонтальные фильтры по уровню
...
- preview текстового body для читаемости payload
...
`VERBOSE`, `DEBUG`, `INFO`, `SUCCESS`, `WARNING`, `ERROR`, `CRITICAL`, `HTTP OUT`, `HTTP IN`
